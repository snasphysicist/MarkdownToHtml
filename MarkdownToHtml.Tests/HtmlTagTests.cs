...
namespace MarkdownToHtml
{
    ...
    public class HtmlTagTests
    {
        ...
        [TestMethod]
        [Timeout(500)]
        public void SelfClosingTagWithIntermediateLineBreakingWhitespaceIsNotAValidHtmlTag()
        {
            HtmlToken[] tokens = new HtmlToken[]
            {
                new HtmlToken(
        ...
        [TestMethod]
        [Timeout(500)]
        public void SeriesOfTokensRepresentingSelfClosingTagWithAttributesIsAValidHtmlTag()
        {
            HtmlToken[] tokens = new HtmlToken[]
            {
                new HtmlToken(
        ...
        [TestMethod]
        [Timeout(500)]
        public void SelfClosingTagWithWhitespaceBetweenSlashAndCloserIsNotAValidHtmlTag()
        {
            HtmlToken[] tokens = new HtmlToken[]
            {
                new HtmlToken(
